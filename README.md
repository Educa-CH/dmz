...
The prototype for issuing a digital maturity certificate and registering at a sample university is currently hosted under:
...
To run this app, you need to have Python 3 installed on your computer. You can download Python 3 from the official Python website:
...
Once you have installed Python 3, you need to install the required packages in the virtual environment by running the following command in your terminal or command prompt:
...
You can then access the app by navigating to that URL in your web browser.
...
# Translations
The translations in the app are done using Babel. To change the translated content or to add another language, run the following commands.
To collect all translatable content, run:
...
Now translate all content to the selected language and compile using:
